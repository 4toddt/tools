...
| View | **All fields** · **Copy** (new/changed merch only) · **Features** (image + feature context; live feature Δ or creates with tags) · **Images** (2+ images only; gallery + image fields) |
